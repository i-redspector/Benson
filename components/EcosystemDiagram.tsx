  ...
  useEffect(() => {
    ...
    const updateDimensions = () => {
      ...
      nodeElements.append("text")
          ...
          .attr("dy", 25 * scaleFactor) // Offset below node
          .attr("fill", d => d.color)
      ...
      // This updates position (x,y) based on angle, but does NOT rotate the group
      // preserving text orientation.
